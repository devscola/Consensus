  ...
  class Courier
    class << self
      ...
      def collect_polymer
        ...
        @engine_main = File.open('vendor/polymer/polymer.html', 'w')
        @engine_mini = File.open('vendor/polymer/polymer-mini.html', 'w')
        @engine_micro = File.open('vendor/polymer/polymer-micro.html', 'w')
        @engine_webcomponents = File.open('vendor/polymer/webcomponents-lite.min.js', 'w')
